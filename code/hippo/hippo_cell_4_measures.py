...
import numpy as np
from hippo_matrix_4_measures import get_hippo_legs, get_hippo_lagt, get_hippo_legt, get_hippo_fout
...
class HiPPOCell_4(nn.Module):
    def __init__(self, N, dt=0.01, measure='legs'):
        """
        HiPPO 记忆单元
        ...
        if measure == 'legs':
            ...
            A, B = get_hippo_legt(N)
        elif measure == 'fout':
            A, B = get_hippo_fout(N)
        else:
...
if __name__ == "__main__":
    ...
    cell = HiPPOCell_4(N=N, dt=dt, measure='legs')
